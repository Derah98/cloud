<?php
session_start();
if(empty($_SESSION["user"] or $_SESSION["password"])){
...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h2 align="center">Welcome <?php echo $_SESSION['user'] ?> To your Cloud Space</a></h2>
   <br />
   <div align="right">
   <button type="button" id="logout" name="logout"  class="btn btn-danger">Logout</button>
